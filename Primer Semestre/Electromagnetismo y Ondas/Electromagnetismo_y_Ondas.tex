...
Se han tomado como importante referencia los apuntes de \href{https://www.etsist.upm.es/escuela/departamentos/EF/personal?departamento=EFF&idTrabajador=02819b0c47b0eac780a7d0e336d9862b}{Marta Sánchez Agudo}, profesora de Electromagnetismo y Ondas en la ETSIST, descargados desde \href{https://apuntesupmcampussur.wordpress.com/}{este blog}. Tambi
en es digno mencionar que he asistido a las clases de \href{https://www.etsist.upm.es/escuela/departamentos/EF/personal?departamento=EFF&idTrabajador=d7cdf3a80e5b5b146334cffaa517eb45}{Francisco Prieto Castrillo} y otra parte importante de sus conocimientos han quedado plasmados en este documento, con mi toque personal.
...
\[ F=ma \qquad  [F]=[m][a]=\frac{[m][v]}{[T]}= \frac{M[v]}{T} = ML/T^2 \]

Por ello podemos expresar muchas unidades del SI en función de unas pocas.

\[ F=ma \qquad  [F]=[m][a] \rightarrow \N = \kg \m \s ^{-2} \]
...
\begin{fleqn}
	\begin{multicols}{4}
		...
		\[\vec{r} = x \hat{i} + y \vec{u_x} + z \vec{u}_z \]
