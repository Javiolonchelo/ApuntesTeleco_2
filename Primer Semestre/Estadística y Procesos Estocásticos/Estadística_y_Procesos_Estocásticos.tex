...
\section{\texorpdfstring{Distribución normal $n$-dimensional}{Distribución normal n-dimensional}}
\section{Teorema central del límite}
\section{\texorpdfstring{$\Xi$ cuadrado y la $T$ de Student}{Chi cuadrado y la T de Student}}
